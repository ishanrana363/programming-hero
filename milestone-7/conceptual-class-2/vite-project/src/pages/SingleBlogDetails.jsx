      ...
      <article className="space-y-8 ">
        <div className="space-y-6">
          ...
          <div className="flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap ">
            ...
            <div onClick={()=>{handleBookmark(blog)}}  className="bg-primary p-3 ml-10 hover:scale-105 overflow-hidden transition rounded-full hover:bg-opacity-20 bg-opacity-30 cursor-pointer ">
              <CiBookmarkPlus />
            </div>
          </div>
        </div>
